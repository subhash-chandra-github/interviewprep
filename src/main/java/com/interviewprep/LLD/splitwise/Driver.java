package com.interviewprep.LLD.splitwise;

import com.interviewprep.LLD.splitwise.expense.ExpenseManager;
import com.interviewprep.LLD.splitwise.expense.ExpenseType;
import com.interviewprep.LLD.splitwise.split.EqualSplit;
import com.interviewprep.LLD.splitwise.split.ExactSplit;
...
//    EXPENSE u1 600 3 u1 u2 u3 EQUAL
//    SHOW
                ...
                case "EXPENSE":
                    ...
                    switch (expenseType) {
                        case "EQUAL":
                            ...
                            break;
                        case "EXACT":  //    EXPENSE u1 1250 2 u2 u3 EXACT 370 880
                            for (int i = 0; i < noOfUsers; i++) {
